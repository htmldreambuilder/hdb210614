...
<ul class=\"no-bullet\">
    ...
    <li>
        ";
        // line 34
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "cuentanosloContactoRapido"), 'widget', array("attr" => array("class" => "radius right small"), "label" => "¡Empecemos!"));
        // line 38
        echo "
    </li>
</ul>
